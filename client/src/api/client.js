...
export const api = {
  ...
  getInstanceTags: (id, region) => request('GET', `/instances/${id}/tags`, null, { region }),
  setInstanceTags: (id, tags, region) => request('POST', `/instances/${id}/tags`, { tags, region }),
  deleteInstanceTags: (id, keys, region) => request('DELETE', `/instances/${id}/tags`, { keys, region }),
